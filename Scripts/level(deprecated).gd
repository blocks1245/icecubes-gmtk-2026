...
#
func LoseGame(): pass # On game loss
...
#
func WinGame(node: Node2D): pass # On game win
	## Output win UI
...
#
func _on_retry_pressed() -> void: pass # When pressing retry
...
#
func _on_mainmenu_pressed() -> void: pass# When pressing main menu
	#get_tree().paused = false # Unpause the scene
	#get_tree().change_scene_to_file("res://Scenes/main_menu.tscn") # Load the main menu
#
func _on_next_level_pressed() -> void: pass # When pressing next level
